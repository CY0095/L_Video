...
- (UIImageView *)topBackImgView {
    if (_topBackImgView == nil) {
        _topBackImgView = [[UIImageView alloc] initWithImage:nil];
...
- (UIImageView *)bottomBackImgView {
    if (_bottomBackImgView == nil) {
        _bottomBackImgView = [[UIImageView alloc] initWithImage:nil];
...
-(UIImageView *)tipsBackImgView {
    if (_tipsBackImgView == nil) {
        _tipsBackImgView = [[UIImageView alloc] initWithImage:nil];
